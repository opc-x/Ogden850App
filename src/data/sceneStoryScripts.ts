...
export const SCENE_STORY_SCRIPTS: SceneStoryScript[] = [
  { sceneKey: 'Shopping', freqRank: 1, tier: 'P0', titleZh: '超市买菜结账', titleEn: 'Grocery Checkout', storyHook: '列清单进超市，挑菜问价，付款装袋回家', storyOutline: [ch('开场', '进超市', '进店问好'), ch('进行', '挑选询价', '找食物看价格'), ch('进行', '付款装袋', '给钱装包'), ch('收束', '回家整理', '离开商店回家')], emoji: '🛒', gradient: 'linear-gradient(135deg,#fef3c7,#a7d9b8)', illustration: { label: '超市结账', motifs: ['cart', 'shelf', 'bag'], accent: '#4faa6a' } },
  { sceneKey: 'Restaurant', freqRank: 2, tier: 'P0', titleZh: '餐厅点菜买单', titleEn: 'Dining Out', storyHook: '入座看菜单，点餐上菜，吃完结账离开', storyOutline: [ch('开场', '入座看单', '找位子要菜单'), ch('进行', '点餐上菜', '点食物和饮料'), ch('进行', '用餐交流', '评价味道'), ch('收束', '结账告别', '付饭钱离开')], emoji: '🍽', gradient: 'linear-gradient(135deg,#e6f4ea,#5cb377)', illustration: { label: '餐厅用餐', motifs: ['table', 'plate', 'menu'], accent: '#2f7d4f' } },
  ...
  { sceneKey: 'Going to the Store', freqRank: 10, tier: 'P0', titleZh: '便利店买日用品', titleEn: 'Quick Errand', storyHook: '列清单买面包牛奶，付款回家', storyOutline: [ch('开场', '列清单出门', '看缺什么'), ch('进行', '选购商品', '拿面包牛奶'), ch('进行', '付款离开', '给钱装袋'), ch('收束', '回家放好', '放进厨房')], emoji: '🏪', gradient: 'linear-gradient(135deg,#fef3c7,#fbbf24)', illustration: { label: '便利店', motifs: ['store', 'bread', 'bag'], accent: '#287045' } },
  { sceneKey: 'The Family', freqRank: 11, tier: 'P1', titleZh: '家人晚饭聊天', titleEn: 'Family Dinner', storyHook: '一家人吃饭，聊今天的事', storyOutline: [ch('开场', '回家团聚', '桌边准备吃'), ch('进行', '边吃边聊', '聊今天的事'), ch('收束', '收拾餐桌', '互道晚安')], emoji: '👨‍👩‍👧', gradient: 'linear-gradient(135deg,#e6f4ea,#a7d9b8)', illustration: { label: '家庭晚餐', motifs: ['table', 'food', 'house'], accent: '#c2410c' } },
  ...
  { sceneKey: 'Online Shopping', freqRank: 15, tier: 'P1', titleZh: '网购下单收货', titleEn: 'Online Order', storyHook: '网上选商品，付款，等货到签收', storyOutline: [ch('开场', '浏览选品', '看图片价格'), ch('进行', '下单付款', '确认地址付钱'), ch('进行', '等待物流', '问何时到'), ch('收束', '签收验货', '收货检查')], emoji: '🛍', gradient: 'linear-gradient(135deg,#fef3c7,#4faa6a)', illustration: { label: '网购收货', motifs: ['box', 'machine', 'money'], accent: '#b45309' } },
  ...
  { sceneKey: 'Moving House', freqRank: 23, tier: 'P1', titleZh: '搬家搬行李', titleEn: 'Moving Day', storyHook: '打包箱子，搬运装车，搬进新家', storyOutline: [ch('开场', '开始打包', '放进箱子'), ch('进行', '搬运装车', '抬重物上车'), ch('收束', '搬进新家', '卸货摆好')], emoji: '📦', gradient: 'linear-gradient(135deg,#fed7aa,#2f7d4f)', illustration: { label: '搬家', motifs: ['box', 'truck', 'house'], accent: '#c2410c' } },
  ...
  { sceneKey: 'My Room', freqRank: 31, tier: 'P1', titleZh: '整理我的房间', titleEn: 'Tidying My Room', storyHook: '打扫房间，归置物品，休息', storyOutline: [ch('开场', '房间很乱', '决定整理'), ch('进行', '打扫归置', '扫地放书'), ch('收束', '休息满意', '坐干净房间')], emoji: '🛏', gradient: 'linear-gradient(135deg,#f0f9f2,#a7d9b8)', illustration: { label: '我的房间', motifs: ['bed', 'shelf', 'broom'], accent: '#2f7d4f' } },
  ...
  { sceneKey: 'Surprised', freqRank: 46, tier: 'P2', titleZh: '意外惊喜反应', titleEn: 'What a Surprise', storyHook: '突然发现意外，表达惊讶，弄清缘由', storyOutline: [ch('开场', '意外发现', '没想到'), ch('进行', '追问缘由', '问怎么回事'), ch('收束', '接受结果', '笑或感慨')], emoji: '😲', gradient: 'linear-gradient(135deg,#fef3c7,#f97316)', illustration: { label: '惊讶', motifs: ['gift', 'wow', 'eyes'], accent: '#2f7d4f' } },
  ...
  { sceneKey: 'Animals', freqRank: 48, tier: 'P2', titleZh: '宠物与动物', titleEn: 'Pets and Animals', storyHook: '看动物、喂食、聊习性', storyOutline: [ch('开场', '遇见动物', '看狗鸟'), ch('进行', '互动喂食', '给水食物'), ch('收束', '告别离开', '说再见')], emoji: '🐕', gradient: 'linear-gradient(135deg,#fef3c7,#fcd34d)', illustration: { label: '动物', motifs: ['dog', 'bird', 'garden'], accent: '#287045' } },
