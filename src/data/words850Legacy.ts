...
/** 第 1 类 · Operations（仅保留词与中文；IPA 统一来自 ANNOTATIONS） */
const OPS_RAW: { w: string; cn: string }[] = [
  { w: "come", cn: "来 (移向观察点)" },
  { w: "get", cn: "得 (获取/进入状态)" },
  { w: "give", cn: "给 (向外传递所有权)" },
  { w: "go", cn: "去 (移离观察点)" },
  { w: "keep", cn: "保持 (留在空间/状态边界内)" },
  { w: "let", cn: "让 (撤销屏障放行)" },
  { w: "make", cn: "做/造 (塑造原材料产出新物)" },
  { w: "put", cn: "放 (松手放下并安置)" },
  { w: "seem", cn: "似乎 (呈现虚像/看似)" },
  { w: "take", cn: "拿 (伸手抓取并移位)" },
  { w: "be", cn: "是/在 (处于静止原点)" },
  { w: "do", cn: "做/执行 (关注过程的动作)" },
  { w: "have", cn: "有/持有 (占有并包含在线框内)" },
  { w: "say", cn: "说 (单向发声传播)" },
  { w: "see", cn: "看/明白 (接收光线进入眼睛)" },
  { w: "send", cn: "送 (借助外力远程传递)" },
  { w: "may", cn: "可以/也许 (可能性分支/许可)" },
  { w: "will", cn: "将/愿意 (指向未来的主观推力)" },
  { w: "about", cn: "在……周围/围绕；关于 (抽象)" },
  { w: "across", cn: "横过/跨越表面" },
  { w: "after", cn: "在……后面 (空间/时间)；在……之后" },
  { w: "against", cn: "靠着/逆着 (物理力学)；反对" },
  { w: "among", cn: "在……群中/环绕之中 (三者及以上)" },
  { w: "at", cn: "在点上 / 在 (特定时空点)" },
  { w: "before", cn: "在……前面 (空间/时间)；在……之前" },
  { w: "between", cn: "在 (两者) 之间 / 处于间隔中" },
  { w: "by", cn: "靠近 / 沿旁 (物理位置)；由 / 通过 (手段/施动者)" },
  { w: "down", cn: "向下 (空间位移)" },
  { w: "from", cn: "来自/起点 (空间/时间源头)" },
  { w: "in", cn: "在……里/处于容器中 (空间/状态)" },
  { w: "off", cn: "离开/脱离接触 (物理脱离)" },
  { w: "on", cn: "在……上/接触表面 (物理支撑)" },
  { w: "over", cn: "在……正上方/越过上方 (无接触空间)" },
  { w: "through", cn: "穿过/通过通道 (三维穿透)" },
  { w: "to", cn: "向/到 (指向目标点)" },
  { w: "under", cn: "在……正下方 (空间)" },
  { w: "up", cn: "向上 (空间位移)" },
  { w: "with", cn: "和……一起 / 伴随 (物理/状态)；用 / 带有" },
  { w: "as", cn: "作为；像 / 如同" },
  { w: "for", cn: "为了；换取" },
  { w: "of", cn: "的 / 属于；关联" },
  { w: "till", cn: "直到 (时间点)" },
