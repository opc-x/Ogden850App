  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div
          className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border ${theme.iconWrap}`}
        >
          <Icon className={`h-[18px] w-[18px] ${theme.iconColor}`} strokeWidth={2.25} />
        </div>
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className={`mt-3 h-2 overflow-hidden rounded-full ${theme.barTrack}`}>
            <div
