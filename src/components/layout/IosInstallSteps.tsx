  ...
  if (guide.sharePlacement === 'bottom') {
    return (
      <div className="rounded-2xl bg-slate-100/90 border border-slate-200 px-3 pt-2.5 pb-3">
        <p className="text-caption font-bold text-slate-400 text-center tracking-wide mb-2">
        ...
        <div className="flex items-end justify-center gap-6 px-2">
          ...
          <div className="flex flex-col items-center gap-1 -mb-0.5">
            ...
            <span className="text-caption font-black text-blue-600">分享</span>
          </div>
          <ToolbarDot />
          <ToolbarDot />
        </div>
      ...
      <div className="rounded-2xl bg-slate-100/90 border border-slate-200 px-3 py-3">
        ...
        <div className="flex items-center justify-end gap-2 px-1">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-caption font-black text-blue-600">{guide.step1Chip}</span>
          </div>
        </div>
      </div>
    );
    ...
    <div className="rounded-2xl bg-slate-100/90 border border-slate-200 px-3 py-3">
      ...
      <div className="flex items-end justify-end gap-3 px-1">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-caption font-black text-blue-600">菜单</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex justify-center mt-3">
      <div className="flex flex-col items-center text-blue-600">
        <span className="text-caption font-black tracking-wide">{guide.lookHint}</span>
    ...
    <div className="space-y-3.5 pr-5">
      ...
      <div className="flex gap-3">
        ...
        <div className="min-w-0 space-y-1.5">
          ...
          {guide.step1Extra && (
            <p className="text-body-sm text-slate-500 font-medium">{guide.step1Extra}</p>
          )}
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <div className="min-w-0 space-y-1.5">
          ...
          {isInApp && (
            <p className="text-body-sm text-slate-500 font-medium">打开 Safari 后会再提示你后 2 步</p>
          )}
          {!isInApp && (
            <p className="text-body-sm text-slate-500 font-medium">菜单可能要往上滑一点才能看到</p>
          )}
        </div>
      </div>
      ...
      {followUp && (
        <div className="rounded-xl bg-emerald-50 border border-emerald-200 px-3 py-2.5 space-y-1">
          <p className="text-body-sm font-black text-emerald-800">Safari 打开后：</p>
          <p className="text-body-sm text-emerald-700 font-medium">① {followUp.step1Title}</p>
          <p className="text-body-sm text-emerald-700 font-medium">② {followUp.step2Title}</p>
        </div>
      )}
